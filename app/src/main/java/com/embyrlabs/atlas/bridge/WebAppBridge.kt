package com.embyrlabs.atlas.bridge
...
import com.embyrlabs.atlas.data.db.EqualizerOverrideEntity
import com.embyrlabs.atlas.data.db.EqualizerOwnerType
import com.embyrlabs.atlas.data.db.NotificationEntity
...
import com.embyrlabs.atlas.data.download.DownloadQueueController
import com.embyrlabs.atlas.data.download.DownloadService
import com.embyrlabs.atlas.data.equalizer.CUSTOM_CURVE_FREQS_HZ
import com.embyrlabs.atlas.data.equalizer.EQ_PRESETS
import com.embyrlabs.atlas.data.equalizer.decodeCustomLevels
import com.embyrlabs.atlas.data.equalizer.encodeCustomLevels
import com.embyrlabs.atlas.data.equalizer.interpolateGainDb
import com.embyrlabs.atlas.data.equalizer.presetById
import com.embyrlabs.atlas.data.settings.SettingsRepository
import com.embyrlabs.atlas.data.settings.ThemeMode
import com.embyrlabs.atlas.data.voiceisolation.VoiceIsolationController
import com.embyrlabs.atlas.data.voiceisolation.VoiceIsolationEngine
import com.embyrlabs.atlas.data.voiceisolation.VoiceIsolationService
import com.embyrlabs.atlas.data.youtube.AudioQuality
import com.embyrlabs.atlas.data.youtube.YouTubeExtractorClient
import com.embyrlabs.atlas.playback.EqualizerLiveOverride
import com.embyrlabs.atlas.playback.PlaybackUiState
import com.embyrlabs.atlas.playback.PlayerController
import com.embyrlabs.atlas.playback.QueueManager
import com.embyrlabs.atlas.update.UpdateChecker
import com.embyrlabs.atlas.update.UpdateDownloader
import com.embyrlabs.atlas.update.UpdateInfo
import com.embyrlabs.atlas.update.UpdateInstaller
...
class WebAppBridge(
    ...
    private suspend fun dispatch(action: String, args: JSONObject): String? = when (action) {
        ...
        "visualizer.start" -> {
            ...
            com.embyrlabs.atlas.playback.VisualizerController.instance.start(if (reduced) 140L else 66L) { bars ->
                push("playback.visualizerData", JSONArray(bars.map { it.toDouble() }).toString())
            }
            null
        }
        "visualizer.stop" -> { com.embyrlabs.atlas.playback.VisualizerController.instance.stop(); null }
